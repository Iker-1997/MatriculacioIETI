      ...
      $.get({
        ...
        $.getJSON({
          ...
          for (const career in response){
            $("tbody").append('<tr class="text-center" data-id="'+response[career][`id`]+'""><td class="border-2 border-mtr-dark"><a href="">'+response[career][`name_careers`]+'</a></td><td class="hidden border-2 border-mtr-dark input"><input value="'+response[career][`name_careers`]+'" type="text" name="nameEdit" class="nameEdit"></td><td class="border-2 border-mtr-dark">'+response[career][`code_careers`]+'</td><td class="hidden border-2 border-mtr-dark input"><input value="'+response[career][`code_career`]+'" type="text" name="codeEdit" class="codeEdit"></td><td class="border-2 border-mtr-dark">'+response[career][`family`]+'</td><td class="hidden border-2 border-mtr-dark input"><input value="'+response[career][`family`]+'" type="text" name="familyEdit" class="familyEdit"></td><td class="border-2 border-mtr-dark">'+response[career][`career_hours`]+'</td><td class="hidden border-2 border-mtr-dark input"><input value="'+response[career][`career_hours`]+'" type="number" name="hoursEdit" class="hoursEdit"></td><td class="p-2 flex flex-col justify-center md:flex-row space-y-2 md:space-y-0 md:space-x-6"><button id="edit" onClick="editRow('+response[career][`id`]+')" class="bg-mtr-dark py-2 px-4 text-white rounded">Edit</button><button id="save" onClick="saveChange('+response[career][`id`]+')" class="hidden bg-mtr-dark py-2 px-4 text-white rounded">Save</button><button id="cancel" onClick="cancelChange('+response[career][`id`]+')" class="hidden bg-red-500 py-2 px-4 text-white rounded">Cancel</button><a href="/admin/terms/delete/'+response[career][`id`]+'" class="bg-red-500 py-2 px-4 text-white rounded">Delete</a></td></tr>');
          }
        });
      });
    }
